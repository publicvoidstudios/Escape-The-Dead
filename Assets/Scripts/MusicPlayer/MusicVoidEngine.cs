...
public class MusicVoidEngine : MonoBehaviour
{
    ...
    [Tooltip("If true, all tracks in list will be randomized")]
    ...
    private static MusicVoidEngine _instance;

    public static MusicVoidEngine instance
    {
        get
        {
            if (_instance == null)
            {//in case not awake yet
                _instance = FindObjectOfType<MusicVoidEngine>();
            }
            return _instance;
        }
    }
